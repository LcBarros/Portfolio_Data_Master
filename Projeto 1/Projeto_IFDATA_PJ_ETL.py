...
PARAMS = {
    ...
    '@Relatorio': "\'13\'", # Carteira de crédito ativa Pessoa Física - modalidade e vencimento
    '$format': 'json'
}
...
df2.to_csv('dados/IFDATA_PJ_db.csv', sep = ';')
...
try:
    ...
    create_script = ''' CREATE TABLE IF NOT EXISTS ifdata_pj (
...
df2.to_sql('ifdata_pj', engine, if_exists='append', index=False)